...
public class ActionGetProductionTest {
    ...
    public void CorrectNumberResources(){
        ...
        actionController.getProduction(0, 1, gameBoard,-1, player,new ExchangeResources(new int[]{0, 0, 2, 0}, new int[]{0,1, 0, 0}, new int[]{0, 0, 0, 3}));
    ...
    public void WrongNumberResourcesSent(){
        ...
        try {
            actionController.getProduction(0, 1, gameBoard, -1, player,new ExchangeResources(new int[]{0,0,0,0}, new int[]{0, 1, 0, 3}, new int[]{0, 0, 0, 0}));
            fail();
        ...
        actionController.getProduction(0, 1, gameBoard, -1, player,new ExchangeResources(new int[]{0,0,0,0}, new int[]{0, 1, 2, 3}, new int[]{0, 0, 0, 0}));
        gameBoard.getDeck(0,1).addCard(new DevelopmentCard(4,2,new int[]{0,0,0,0},null,null, Colors.BLUE,2));
        actionController.getProduction(0, 1, gameBoard, -1, player,new ExchangeResources(new int[]{0,0,0,0}, new int[]{0, 0, 0, 0}, new int[]{0, 0, 0, 0}));
        assertEquals(0, gameBoard.getDeck(0, 1).DeckLength());
        }
    @Test
    ...
    public void winnerException(){
        ...
        gameBoard.getDeck(0,1).addCard(new DevelopmentCard(4,2,new int[]{0,0,0,1},null,null, Colors.BLUE,1));
        gameBoard.getDeck(0,1).addCard(new DevelopmentCard(4,2,new int[]{0,0,0,1},null,null, Colors.BLUE,1));
        gameBoard.getDeck(0,1).addCard(new DevelopmentCard(4,2,new int[]{0,0,0,1},null,null, Colors.BLUE,1));
        gameBoard.getDeck(0,1).addCard(new DevelopmentCard(4,2,new int[]{0,0,0,1},null,null, Colors.BLUE,2));
        gameBoard.getDeck(0,1).addCard(new DevelopmentCard(4,2,new int[]{0,0,0,1},null,null, Colors.BLUE,2));
        gameBoard.getDeck(0,1).addCard(new DevelopmentCard(4,2,new int[]{0,0,0,1},null,null, Colors.BLUE,2));
        gameBoard.getDeck(0,1).addCard(new DevelopmentCard(4,2,new int[]{0,0,2,0},null,null, Colors.BLUE,3));

        player.getPlayerBoard().addStrongboxResource(Resources.SHIELD,10);
        player.getPlayerBoard().addWarehouseResource(Resources.STONE,2);
        player.getPlayerBoard().addWarehouseResource(Resources.STONE,2);

        actionController.getProduction(0, 1, gameBoard,-1, player,new ExchangeResources(new int[]{0, 0, 0, 0}, new int[]{0,0, 0, 1}, new int[]{0, 0, 0, 0}));
        assertEquals(6, gameBoard.getDeck(0, 1).DeckLength());
        actionController.getProduction(0, 1, gameBoard,-1, player,new ExchangeResources(new int[]{0, 0, 0, 0}, new int[]{0,0, 0, 1}, new int[]{0, 0, 0, 0}));
        assertEquals(5, gameBoard.getDeck(0, 1).DeckLength());
        actionController.getProduction(0, 1, gameBoard,-1, player,new ExchangeResources(new int[]{0, 0, 0, 0}, new int[]{0,0, 0, 1}, new int[]{0, 0, 0, 0}));
        assertEquals(4, gameBoard.getDeck(0, 1).DeckLength());

        actionController.getProduction(0, 1, gameBoard,0, player,new ExchangeResources(new int[]{0, 0, 0, 0}, new int[]{0,0, 0, 1}, new int[]{0, 0, 0, 0}));
        assertEquals(3, gameBoard.getDeck(0, 1).DeckLength());
        actionController.getProduction(0, 1, gameBoard,1, player,new ExchangeResources(new int[]{0, 0, 0, 0}, new int[]{0,0, 0, 1}, new int[]{0, 0, 0, 0}));
        assertEquals(2, gameBoard.getDeck(0, 1).DeckLength());
        actionController.getProduction(0, 1, gameBoard,2, player,new ExchangeResources(new int[]{0, 0, 0, 0}, new int[]{0,0, 0, 1}, new int[]{0, 0, 0, 0}));
        assertEquals(1, gameBoard.getDeck(0, 1).DeckLength());
        try {
            actionController.getProduction(0, 1, gameBoard, 0, player, new ExchangeResources(new int[]{0, 0, 2, 0}, new int[]{0, 0, 0, 0}, new int[]{0, 0, 0, 0}));
        fail();
