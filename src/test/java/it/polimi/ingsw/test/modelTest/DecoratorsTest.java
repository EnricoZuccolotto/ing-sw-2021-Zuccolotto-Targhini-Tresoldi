...
/**
 * This class checks that the LeaderCard decorators work.
 */
public class DecoratorsTest{
    /**
     * Checks if a leader card advantage doesn't work in a simple board.
     */
    @Test
    ...
    /**
     * Tests the warehouse decorator (and the failure of other actions).
     */
    @Test
    ...
    /**
     * Tests the discount decorator (and the failure of other actions).
     */
    @Test
    ...
    /**
     * Tests the white marble decorator (and the failure of other actions).
     */
    @Test
    ...
    /**
     * Tests the special production decorator (and the failure of other actions).
     */
    @Test
    ...
    /**
     * Tests if two decorators work (and the failure of other actions).
     */
    @Test
