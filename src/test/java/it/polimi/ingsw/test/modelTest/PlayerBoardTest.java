...
public class PlayerBoardTest {
    ...
    /**
     * Tests if leader cards are added correctly to the board.
     */
    @Test
    ...
    /**
     * Tries to add leader card effects to a non-decorated board and check it fails.
     */
    @Test
    ...
    /**
     * Tests the warehouse functions associated to the board.
     */
    @Test
    ...
    /**
     * Adds some production cards, checks if they work and checks if an illegal production is noted.
     */
    @Test
    ...
    /**
     * Checks the strongbox handling in the board.
     */
    @Test
    ...
    /**
     * Checks that victory points are correctly handled.
     */
    @Test
